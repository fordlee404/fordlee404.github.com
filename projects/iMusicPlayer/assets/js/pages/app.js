(function() {
  var $fileInput, $nextBtn, $pauseBtn, $playBtn, $player, $preBtn, $uploadBtn, createNotify, currentTag, musicList, playMusic, reader, updateMusicList;
  ...
  createNotify = function(music_name) {
    ...
    if (window.Notification.permission === 'default') {
      return window.Notification.requestPermission(function() {
        return createNotify(music_name);
      });
  ...
  updateMusicList = function(files) {
    var music, playFlag, _i, _len, _results;
    playFlag = false;
    _results = [];
  ...
  $fileInput.bind('change', function() {
    return updateMusicList(this.files);
  });
  ...
  window.document.ondragover = function(e) {
